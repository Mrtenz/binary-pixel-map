/**
 * Slightly modified version of `oled-font-5x7` by noopkat.
 * https://github.com/noopkat/oled-font-5x7/blob/master/oled-font-5x7.js
 */

export const monospace: boolean = true;

export const width: number = 5;

export const height: number = 7;
...
/**
 * Lookup a character in the font map. Returns a sequence of bytes or undefined if the character was not found.
 * @param character
 */
export const lookup = (character: string): number[] | undefined => {
  const length = Math.ceil((width * height) / 8);
  const index = lookupTable.indexOf(character);
